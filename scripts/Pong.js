...
const ball = {
  ...
  tick: function() {
    ...
    if (this.xDirection === 1) this.x -= this.vx;
    else if (this.xDirection === 0) this.x += this.vx;

    if (this.yDirection === 0) this.y -= this.vy;
    else if (this.yDirection === 1) this.y += this.vy;
